  ...
  factory AuthUser.fromJson(Map<String, dynamic> json) {
    try {
      return AuthUser(
        ...
        profilePicture: json['profile_picture'] ?? '', // Default to empty string
        registryNumber: json['registry_number'] ?? '', // Default to empty string
        familyTreeName: json['family_tree_name'] ?? '', // Default to empty string
        ...
        stateCityLiving: json['state_city_living'] ?? '', // Default to empty string
        townDistrictLiving: json['town_district_living'] ?? '', // Default to empty string
        validAddressLiving: json['valid_address_living'] ?? '', // Default to empty string
        postalAddress: json['postal_address'] ?? '', // Default to empty string (nullable)
        homePhoneNumber: json['home_phone_number'] ?? '', // Default to empty string (nullable)
        phoneNumber: json['phone_number'] ?? '', // Default to empty string
        phoneNumberEmergency: json['phone_number_emergency'] ?? '', // Default to empty string
        country: json['country'] ?? '', // Default to empty string
        ethnicity: json['ethnicity'] ?? '', // Default to empty string
        socialBackground: json['social_background'] ?? '', // Default to empty string
        stateCityOfBirth: json['state_city_of_birth'] ?? '', // Default to empty string
        townDistrictOfBirth: json['town_district_of_birth'] ?? '', // Default to empty string
        placeOfBirth: json['place_of_birth'] ?? '', // Default to empty string
        education: json['education'] ?? '', // Default to empty string
        currentAcademicDegree: json['current_academic_degree'] ?? '', // Default to empty string
        profession: json['profession'] ?? '', // Default to empty string (nullable)
        professionCertification: json['profession_certification'] ?? '', // Default to empty string (nullable)
        passportNumber: json['passport_number'] ?? '', // Default to empty string
        married: json['married'] ?? '', // Default to empty string
        militaryService: json['military_service'] ?? '', // Default to empty string
        pensionsEstablished: json['pensions_established'] ?? '', // Default to empty string (nullable)
        additionalNotes: json['additional_notes'] ?? '', // Default to empty string (nullable)
        bloodType: json['blood_type'] ?? '', // Default to empty string (nullable)
        driversCertificate: json['drivers_certificate'] ?? '', // Default to empty string
        driversCertificateNumber: json['drivers_certificate_number'] ?? '', // Default to empty string
