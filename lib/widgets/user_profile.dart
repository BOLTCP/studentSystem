                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildProfileCard('Төлөв', userDetails.teacher!.isActive),
                      ...
                      _buildProfileCard(
                          'Багшийн И-мэйл', userDetails.teacher!.teacherEmail),
                      _buildProfileCard(
                          'Өмнөх боловсрол', userDetails.user.education),
                      _buildProfileCard('Created At',
                          userDetails.user.createdAt.toLocal().toString()),
                    ],
                  ),
                ),
              ),
