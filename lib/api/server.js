...
app.post('/User/Signup/Create/User/Teacher', async (req, res) => {
  ...
  try {
    ...
    if (result.rows[0].count === '0') {
      ...
      const branch_school = branches.rows[0].departments_of_education_id
      ...
      const teacherData = {
        ...
        job_post: jobPost,
        departmenst_of_education_id: departmenstOfEducation,
        department_id: branchSchool,
        };
