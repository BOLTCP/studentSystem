...
app.get('/Get/Current/CoursesPlanning/Of/Teacher', async (req, res) => {
  ...
  try {
    const current_courses_teacher = await client.query(`
      SELECT * FROM teachercourseplanning WHERE teacher_id = $1`, [teacher_id]);
...
app.post('/Add/Courses/OfMajor/To/Teacher', async (req, res) => {
  ...
  try {
    ...
    const courseToAddQuery = `
      INSERT INTO public.teachercourseplanning (teacher_id, major_name, major_id, course_name, credit, course_id,
      department_id, department_of_edu_id) 
      VALUES (
        $1, $2, $3, $4, $5, $6, $7, $8
