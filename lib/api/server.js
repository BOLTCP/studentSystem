...
app.post('/Add/Classroom/To/Teachers/Course', async (req, res) => {
  const { classroom, course, dayOfWeek, periodOfWeek, info, teachersCoursesClassrooms, coursesClassroomsPositions } = req.body;
  /*
  console.log(`/Add/Classroom/To/Teachers/Course Received data of classroom: ${classroom.classroom_number}, 
    course of: ${course.course_name}, dayOfWeek: ${dayOfWeek}, periodOfDay: ${periodOfWeek}`);
  */
  console.log(teachersCoursesClassrooms);

  //console.log(coursesClassroomsPositions);
  try {
