...
app.delete('/Remove/Course/From/Teacher', async (req, res) => {
  ...
  console.log('/Remove/Course/From/TeacherRecieved Teacher Id of:', teacher_id, 'to remove Course Id of:', course_id);

  try {
    
    const courseToRemoveQuery = await client.query(`
      DELETE FROM teacherscourseplanning WHERE teacher_id =$1 and course_id = $2`,
