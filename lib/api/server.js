...
app.post('/Add/Classroom/To/Teachers/Course', async (req, res) => {
  ...
  try {
    ...
    for (i=0; i<coursesClassrooms.length; i+=2) {
      ...
      console.log(dayOfWeek, periodOfDay);
      ...
      if (classroomToTeacherQuery.rows.length > 0) {
        ...
        errorMessages.push(`Багшийн ${coursesClassrooms[i+1].course_name} хичээлийг амжилтай ${dayOfWeek} 
        ...
        console.log(`Багшийн ${coursesClassrooms[i+1].course_name} хичээлийг амжилтай ${dayOfWeek} 
          өдөрт ${periodOfDay} цагт ${coursesClassrooms[i].classroom_id} ангид 
          нэмэх болмжгүй байна. Аль нэг байршил дээр давхцал үүссэн байна!`);
      }
